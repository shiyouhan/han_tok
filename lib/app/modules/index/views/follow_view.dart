...
import '../../../data/video/controller/follow_list_controller.dart';
...
class FollowView extends GetView {
  ...
  Widget build(BuildContext context) {
    FollowController controller = Get.put(FollowController());
    return Scaffold(
      resizeToAvoidBottomInset: true, //输入框抵住键盘
      body: Obx(() => controller.followList.isEmpty
...
class _RecommendPageState extends State<RecommendPage>
  ...
  final FollowListController _videoListController = FollowListController();

  /// 记录点赞
  Map<int, bool> favoriteMap = {};

  List<VideoFollow> videoDataList = [];
  ...
  @override
  void initState() {
    videoDataList = VideoFollow.fetchVideo();
