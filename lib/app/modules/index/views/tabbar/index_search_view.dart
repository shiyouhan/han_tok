        ...
        () => controller.videoList.isEmpty
            ? Center(
                child: Column(
                  ...
                  children: [
                    Text('搜索作品', style: BaseStyle.fs16),
                    SizedBox(height: 10.h),
                    Text('你可以搜索用户公开的视频', style: BaseStyle.fs14G),
                    Text('(输入视频标题内容)', style: BaseStyle.fs14G),
                  ],
                ),
              )
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onSubmitted:
                                                                          ...
                                                                          controller
                                                                              .vlogId
                                                                              .value = element.vlogId;
                                                                          controller
                                                                              .vlogerId
                                                                              .value = element.vlogerId;
                                                                          controller
                                                                              .commentCreate();
                                                                        },
                                                                      ),
