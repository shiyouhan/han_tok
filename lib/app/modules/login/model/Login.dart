// ignore_for_file: file_names, prefer_void_to_null, no_leading_underscores_for_local_identifiers
...
class Login {
  Login({
    ...
    this.myFollowsCounts,
    this.myFansCounts,
    this.totalLikeMeCounts,
  });
  ...
  late final Null myFollowsCounts;
  late final Null myFansCounts;
  late final Null totalLikeMeCounts;
